...
public class LibrarianManagementJPanel extends javax.swing.JPanel {
    ...
    public LibrarianManagementJPanel(AppSystem appSystem, UserAccount useraccount){
        initComponents();
...
//        populate(); 
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(ua.accountExists(fieldUsername.getText(), fieldPassword.getText(), "librarian")){
            JOptionPane.showMessageDialog(null, "Sorry credentials are taken.");
        } else{
            UserAccount user = ua.createUserAccount(fieldUsername.getText(), fieldPassword.getText(), "librarian");
            Librarian l = new Librarian();
            l.setAge(fieldAge.getText());
            l.setName(fieldName.getText());
            l.setPersonID(user.getAccountId());
            this.appSystem.setLibrarian(l);   
            populate();
        }
